...
class FrameTHT(ctk.CTkFrame):
    def __init__(self, container):
        ...
        self.label_band_4 = ctk.CTkLabel(self, text='Multiplier', font=('Ubuntu Light', 12, 'bold'))
        self.label_band_4.grid(column=3, row=1)

        self.label_band_1 = ctk.CTkLabel(self, text='Tolerance', font=('Ubuntu Light', 12, 'bold'))
        ...
        # self.combobox_band_1._entry.configure(readonlybackground='#2B8FDE')
...
class FrameSMD(ctk.CTkFrame):
    def __init__(self, container):
        super().__init__(container, height=230, width=500, corner_radius=10)

        frames_name = ctk.CTkLabel(self, text='SMD Resistors', text_color='white', font=('Ubuntu Light', 12))
        frames_name.grid(column=0, row=0, sticky=tkinter.SW, padx=10)


class FrameCapacitor(ctk.CTkFrame):
    def __init__(self, container):
        super().__init__(container, height=230, width=440, corner_radius=10)

        frames_name = ctk.CTkLabel(self, text='Capacitors', text_color='white', font=('Ubuntu Light', 12))
        frames_name.grid(column=0, row=0, sticky=tkinter.SW, padx=10)


class FrameSelectCodeTHT(ctk.CTkFrame):
    def __init__(self, container):
        super().__init__(container, height=90, width=360, corner_radius=10, fg_color='#242424')

        frames_name = ctk.CTkLabel(self, text='Select number of bands', text_color='white', font=('Ubuntu Light', 12))
        frames_name.grid(column=0, row=0, sticky=tkinter.SW, padx=10)
